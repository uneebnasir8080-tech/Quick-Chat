...
// get all the images from messages and set them into state 
...
useEffect(()=>{
  ...
  return selectedUser&& (
    <div className={`bg-[#8185B2]/10 text-white w-full relative  overflow-y-auto chat-container ${selectedUser ? "max-md:hidden":""}`}>
